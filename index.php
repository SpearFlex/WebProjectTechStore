...
if (isset($_POST['btn-login'])) {
 ...
 //If password not match, show error.
  ...
  $msg = "<div>
          <h3 style=\"color: red\"> &nbsp; Неправильный логин или пароль! </h3>
          </div>";
 }
 $DBcon->close();
}
...
<center>
      ...
      ?>
        <div>
        <input style="width: 25%; height: 5%; border-radius: 5px;" type="text" class="form-control" placeholder="Введите логин" name="username" required />
        <span></span>
        </div>
        

        <div>
        <input style="width: 25%; height: 5%; border-radius: 5px;" type="password" class="form-control" placeholder="Введите пароль" name="password" required />
        </div>
      ...
      <hr />
            ...
            <br>
            <br>
            <a id="signup" href="register.php" class="btn btn-default">Нету аккаунта? Нажмите здесь для регистрации!<br><br><br><br><br><br></a>
