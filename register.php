...
if(isset($_POST['btn-signup'])) {
 ...
 if ($count==0) { 
  ...
  if ($DBcon->query($query)) {
   $msg = "<div>
           <h3 style=\"color: red\"> &nbsp; Успешно зарегистрировались !</h3>
           </div>";
  }
 ...
 //Otherwise, email is already taken. Cannot use.
  ...
  $msg = "<div>
          <h3 style=\"color: red\"> &nbsp; Данный логин уже занят !</h3>
          </div>";
...
<center>
       ...
       <form method="post" id="register-form">
        ...
        <br>
        <br>
        <a id="login" href="index.php" class="btn btn-default">Уже имеется аккаунт? Нажмите чтобы войти</a>
        </div>
